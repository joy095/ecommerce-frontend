                ...
                <div>
                  <div className="form-chekbox">
                    <input
                      ...
                      id=""
                    />
                    <label htmlFor="color" className="form-check-lable">
                      In Store (1)
                    </label>
                  </div>
                  <div className="form-chekbox">
            ...
            <div className="filter-card mb-3">
              ...
              <div>
                <div className="random-products mb-3 d-flex">
                  ...
                  <div className="w-50">
                    <h5>
                      Kids heanphones bulk 10 pack multi colored for student
                    </h5>
                    <ReactStars
                      count={5}
                      size={24}
              ...
              <div className="d-flex justify-content-between align-items-center">
                <div className="d-flex align-items-center gap-10">
                  ...
                  >
                    ...
                    <option value="price-descending">Price, high to to</option>
                    <option value="created-ascending">Data, old to new</option>
